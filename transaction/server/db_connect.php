<?php
	...
	*/
	...
	$db_username 	=	"gocordova";			// specify database username | default is "root"
	$db_password 	=	"nebula666$$##";				// specify database password | leave as blank if database has no password set 
